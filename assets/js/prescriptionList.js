...
clientPromotion: `<div class="d-flex align-items-center justify-content-end edit-logos-2 gap-2">
    ...
    function renderTable() {
      ...
      data.forEach((item) => {
        ...
        row.innerHTML = `
            ...
            <td class="" ><span class="responsive-lable d-lg-none">Issued</span>${
              item.issued
            }</td>
            <td class="" ><span class="responsive-lable d-lg-none">Last ordered</span>${
              item.lastOrder
            }</td>
              <td><span class="responsive-lable d-lg-none">Expires</span>${
              item.expires
            }</td>
            <td>
