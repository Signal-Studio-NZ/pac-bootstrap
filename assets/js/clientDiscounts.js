const data = [
    {
        ...
        unitWholesale: '$12.40',
        unitRetail: '$20.00',
        markup: `25% <span class="off-retail">Off Retail</span>`,
    ...
    },
    {
        ...
        markup: `25% <span class="off-retail">Off Retail</span>`,
        discontedPrice: '$15.00',
        action:` <div class="d-flex align-items-center edit-logos justify-content-end">
          <img src="assets/svgs/percentage.svg" class="pointer" alt="discount percent">
          <img src="assets/svgs/details.svg" class="pointer" alt="details">
          <img src="assets/svgs/edit.svg" class="pointer" alt="edit">
          <img src="assets/svgs/close.svg" class="pointer" alt="">
    ...
    function renderTable() {
      ...
      data.forEach((item) => {
        ...
        row.innerHTML = `
            ...
            <td>
            <span class="responsive-lable d-lg-none">Unit Wholesale</span>${
              item.unitWholesale
            }
            </td>
            <td class="" ><span class="responsive-lable d-lg-none">Unit retail</span>${
              item.unitRetail
            }</td>
            <td class="" ><span class="responsive-lable d-lg-none">Markup/Discount</span>${
              item.markup
            }</td>
             <td>
            <span class="responsive-lable d-lg-none">Discounted price</span>${
              item.discontedPrice
            }</td>
              <td>
